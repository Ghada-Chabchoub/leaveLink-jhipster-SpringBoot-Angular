...
import com.leave.link.security.*;
import com.leave.link.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/admin/users")).hasAuthority(AuthoritiesConstants.ADMIN)
                    .requestMatchers(mvc.pattern("/api/admin/users/{login}")).permitAll()
