...
/**
 * REST controller for managing {@link com.leave.link.domain.LeaveRequest}.
 */
@RestController
...
public class LeaveRequestResource {
    ...
    public ResponseEntity<List<LeaveRequestDTO>> getAllLeaveRequests(
        ...
        Page<LeaveRequestDTO> page = Page.empty(); // Initialisation avec une page vide par défaut
        ...
        if (authentication.getAuthorities().stream().anyMatch(a -> a.getAuthority().equals("ROLE_ADMIN"))) {
            ...
            page = leaveRequestService.findAllforEmp(pageable);
        }
