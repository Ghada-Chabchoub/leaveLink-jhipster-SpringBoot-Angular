...
import static com.leave.mang.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.leave.mang.service.mapper.LeaveRequestMapper;
...
class LeaveRequestResourceIT {
    ...
    void partialUpdateLeaveRequestWithPatch() throws Exception {
        ...
        partialUpdatedLeaveRequest.title(UPDATED_TITLE).fromDate(UPDATED_FROM_DATE);
